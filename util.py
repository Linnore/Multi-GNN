...
def create_parser():
    ...
    parser.add_argument("--ibm_data_loading",action=argparse.BooleanOptionalAction, default=True, help="Use the default data loading method in IBM. ")
    parser.add_argument("--root", type=str, help="root for data_loading using AMLworld.py")
    parser.add_argument("--opt", type=str, help="Choosing the opt of AMLworld.py", default="HI-Small")
